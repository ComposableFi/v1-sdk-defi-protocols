...
var TokenExchange_json_1 = __importDefault(require("./abi/TokenExchange.json"));
var CurveToken_json_1 = __importDefault(require("./abi/CurveToken.json"));
var addresses = {
    CurveTokenAbi: CurveToken_json_1.default,
    TokenExchangeAbi: TokenExchange_json_1.default,
    mainnet: {
        BasePools: {
